...
| | | **context-snapshot** | 上下文快照。基于 tool-actions.log 确定性生成已读清单（context-ledger），防重复读取 + 统计 token 开销 |
...
│   ├── framework/          # 框架层：reflecting / state-checkpoint / env-check / context-snapshot / hook-init
...
├── templates/              # 默认产出模板
├── tools/                  # 运行时工具：verify.js / env-check.js / context-snapshot.js / workflow-lib.js / workflow-init.js / skill-log.js / review-brief.js / simple-yaml.js
